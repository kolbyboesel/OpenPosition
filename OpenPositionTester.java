...
public class OpenPositionTester {
	...
	public static boolean testApplicationIterator() {
		...
		if (testIterator.next() == test2 && testIterator.next() == test1 && testIterator.next() == test3) {
			return true;
		}
	...
	public static boolean testOpenPosition() {
		...
		Application test1 = new Application("Kolby", "kolbyzboesel@gmail.com", 94);
		Application test2 = new Application("Kolby", "kolbyzboesel@gmail.com", 91);
		Application test3 = new Application("Kolby", "kolbyzboesel@gmail.com", 97);
		Application test4 = new Application("Kolby", "kolbyzboesel@gmail.com", 54);
		...
		if (tester.getApplications().trim().equals("Kolby:kolbyzboesel@gmail.com:91" + "\n" + "Kolby:kolbyzboesel@gmail.com:94"
				+ "\n" + "Kolby:kolbyzboesel@gmail.com:97") && tester.getTotalScore() == 282) {
			check2 = true;
		}
		...
		tester.add(test5);
		if (tester.getApplications().trim().equals("Kolby:kolbyzboesel@gmail.com:94" + "\n" + "Kolby:kolbyzboesel@gmail.com:97"
				+ "\n" + "Kolby:kolbyzboesel@gmail.com:99") && tester.getTotalScore() == 290) {
			check4 = true;
		}
