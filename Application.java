...
public class Application implements Comparable<Application> {
	...
	public Application(String name, String email, int score) {
		...
		if (name == null || name.equals("") || email == null || score < 0 || score > 100) {
	...
	/**
	 * this method Compares this Applicant to another applicant based on their score
	 * 
	 * @param other The other applicant to be compared to
